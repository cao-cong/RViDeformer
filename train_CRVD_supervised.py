...
parser.add_argument('--num_epochs', dest='num_epochs', type=int, default=40000, help='num_epochs') # set epoch num
...
model_name = "RViDeformer-L_CRVD"
#model_name = "RViDeformer-M_CRVD"
#model_name = "RViDeformer-S_CRVD"
#model_name = "RViDeformer-T_CRVD"
...
for epoch in range(initial_epoch, args.num_epochs+1):
    ...
    if not use_scheduler:
        ...
        #RViDeformer-M epoch35.1k
        #if epoch>19400:
        #    learning_rate = 0.5*learning_rate_base
        #if epoch>23500: 
        #    learning_rate = 0.2*learning_rate_base
        #RViDeformer-S epoch24.4k
        #if epoch>19200: 
        #    learning_rate = 0.5*learning_rate_base
        #RViDeformer-T epoch24.8k
